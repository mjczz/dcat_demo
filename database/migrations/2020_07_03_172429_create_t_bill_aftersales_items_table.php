...
class CreateTBillAftersalesItemsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('t_bill_aftersales_items', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('t_bill_aftersales_items');
    }
}
